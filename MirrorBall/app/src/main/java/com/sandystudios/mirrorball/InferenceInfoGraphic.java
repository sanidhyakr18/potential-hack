...
public class InferenceInfoGraphic extends com.sandystudios.mirrorball.GraphicOverlay.Graphic {

  private static final int TEXT_COLOR = Color.WHITE;
  private static final float TEXT_SIZE = 60.0f;

  private final Paint textPaint;
  private final com.sandystudios.mirrorball.GraphicOverlay overlay;
  ...
  public InferenceInfoGraphic(
          com.sandystudios.mirrorball.GraphicOverlay overlay, double latency, @Nullable Integer framesPerSecond) {
    super(overlay);
