...
public class CameraSource {
  ...
  private final com.sandystudios.mirrorball.GraphicOverlay graphicOverlay;
  ...
  private com.sandystudios.mirrorball.VisionImageProcessor frameProcessor;
  ...
  public CameraSource(Activity activity, com.sandystudios.mirrorball.GraphicOverlay overlay) {
  ...
  public void setMachineLearningFrameProcessor(com.sandystudios.mirrorball.VisionImageProcessor processor) {
    synchronized (processorLock) {
      cleanScreen();
      if (frameProcessor != null) {
        frameProcessor.stop();
        ...
        try {
          synchronized (processorLock) {
            frameProcessor.processByteBuffer(
                data,
                new com.sandystudios.mirrorball.FrameMetadata.Builder()
