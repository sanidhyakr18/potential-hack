...
public class BitmapUtils {
  ...
  @Nullable
  public static Bitmap getBitmap(ByteBuffer data, com.sandystudios.mirrorball.FrameMetadata metadata) {
    data.rewind();
  ...
  public static Bitmap getBitmap(ImageProxy image) {
    com.sandystudios.mirrorball.FrameMetadata frameMetadata =
